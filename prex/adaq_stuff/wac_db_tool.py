...
#        self.selection.set_selectioin_function(self.select_function)
        ...
        self.rbutton2.set_label("Bad")
        self.rbutton2.connect("toggled", self.on_rbutton_toggled, "Bad")

        self.rbutton3 = Gtk.RadioButton.new_from_widget(self.rbutton0)
        self.rbutton3.set_label("Suspicous")
        self.rbutton3.connect("toggled", self.on_rbutton_toggled, "Suspicious")

        fixed.put(self.rbutton1, 125, 370)
        fixed.put(self.rbutton2, 200, 370)
